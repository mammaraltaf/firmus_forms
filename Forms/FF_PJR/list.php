...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3>Identificación de Beneficiario, Director, Representante Legal, Protector u Otros (FF-PJR-ES-V.01)</h3>
...
echo "</tbody>";
echo "</table>";
echo "<a href='FOR_FF_PJR_ES.html' class='btn btn-success mt-3'>Add New FORM: FOR_FF_PJR_ES</a>";
?>
</div>
