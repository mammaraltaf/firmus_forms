...
echo "<h3>Autocertificación de Residencia Fiscal para Personas que Ejercen Control (FF-ECA-ES-V.01)</h3>";
...
echo "</table>";
echo "<br>";
echo "+<a class='active5' href=FOR_FF_ECA_ES.html>Add New FORM : FOR_FF_ECA_ES</a>";
