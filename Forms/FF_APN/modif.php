...
$db->query("update FOR_FF_APN_ES set
Contract_Type=$Contract_Type,
Part_Rel=$Part_Rel,
Part_Rel_Raison=$Part_Rel_Raison,
E_Name=$E_Name,
E_surname=$E_surname,
E_Country=$E_Country,
...
Initial_Deposit_Cash=$Initial_Deposit_Cash,
Initial_Deposit_Non_Securities=$Initial_Deposit_Non_Securities,

Initial_Deposit_Both=$Initial_Deposit_Both,
Initial_Deposit_USD_Amount=$Initial_Deposit_USD_Amount,
Initial_Deposit_Securities_Amount=$Initial_Deposit_Securities_Amount,
Initial_Deposit_From1=$Initial_Deposit_From1,
Initial_Deposit_From1_Cash=$Initial_Deposit_From1_Cash,
Initial_Deposit_From1_Securities=$Initial_Deposit_From1_Securities,
Initial_Deposit_From2=$Initial_Deposit_From2,
Initial_Deposit_From2_Cash=$Initial_Deposit_From2_Cash,
Initial_Deposit_From2_Securities=$Initial_Deposit_From2_Securities,
Initial_Deposit_From1_Rel=$Initial_Deposit_From1_Rel,
Initial_Deposit_From2_Rel=$Initial_Deposit_From2_Rel,
PEP=$PEP,
PEP_Close=$PEP_Close,
PEP_Five=$PEP_Five,
Orders_Autorise_Owner=$Orders_Autorise_Owner,
Orders_Autorise_Co_Owner=$Orders_Autorise_Co_Owner,
Orders_Autorise_Signatory=$Orders_Autorise_Signatory,
Orders_Autorise_Attorney=$Orders_Autorise_Attorney,
Orders_Autorise_Beneficiary_Shareholder=$Orders_Autorise_Beneficiary_Shareholder,
Send_receive_cash_Autorise_Owner=$Send_receive_cash_Autorise_Owner,
Send_receive_cash_Autorise_Co_Owner=$Send_receive_cash_Autorise_Co_Owner,
Send_receive_cash__Autorise_Signatory=$Send_receive_cash__Autorise_Signatory,
Send_receive_cash_Autorise_Attorney=$Send_receive_cash_Autorise_Attorney,
Send_receive_cash__Beneficiary_Shareholder=$Send_receive_cash__Beneficiary_Shareholder,
Orders_Mail=$Orders_Mail,
Orders_Documents=$Orders_Documents,
Orders_Telephone=$Orders_Telephone,
Orders_text=$Orders_text,
Orders_Directly=$Orders_Directly,
Orders_All_Above=$Orders_All_Above,
Autorise_Give_instuctions=$Autorise_Give_instuctions,
Complete1=$Complete1,
Complete2=$Complete2,
Complete3=$Complete3,
Complete4=$Complete4,
Autorise_Firmus=$Autorise_Firmus,
Receive_AS_Mail=$Receive_AS_Mail,
Receive_AS_Postal=$Receive_AS_Postal,
Receive_Mensual=$Receive_Mensual,
Receive_Trimestral=$Receive_Trimestral,
Receive_Semestral=$Receive_Semestral,
Receive_Anual=$Receive_Anual,
...
Signature1_Date=$Signature1_Date,
Signature2_Date=$Signature2_Date,
...
Chief_Executive_Signature=$Chief_Executive_Signature where id=$id
");
