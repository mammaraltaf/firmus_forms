...
$db->query("SELECT id,account_number,E_Name, E_surname,E_Country FROM  FOR_FF_APN_ES order by id");

echo "<h3>Apertura de Cuenta Persona Natural (FF-APN-ES-V.01)</h3>";
...
//    <td><a href=pdf/form_pdf.php?id=$id><img src=../images/pdf.png title=View_PDF></a></td>
...
echo "</table>";
echo "<br>";
echo "+<a href=FOR_FF_APN_ES.html>Add New FORM : FOR_FF_APN_ES</a>";
