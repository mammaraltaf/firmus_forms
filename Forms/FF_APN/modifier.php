...
$Initial_Deposit_Both= isset($data['Initial_Deposit_Both']) ? $data['Initial_Deposit_Both'] : 0;
...
$Orders_All_Above=$data['Orders_All_Above'];
      ...
      <div class="fields-block-wrapper">
        ...
        <div class="d-flex align-items-center">
          <div class="single-field flex-50">
            ...
            <div class="horizontal-form-field">
              <p>2-</p>
              <input name="Initial_Deposit_From2" type="number"  value="<?PHP echo $Initial_Deposit_From2 ; ?>"  class="form-control">
            </div>
          </div>
          <div class="single-field flex-20">
            <div class="checkboxes-group">
          ...
          <div class="single-field flex-30">
            <div class="vertical-form-field">
              <input name="Initial_Deposit_From1_Rel"   type="number" value="<?PHP echo $Initial_Deposit_From1_Rel; ?>"  class="form-control">
            </div>
            <div class="vertical-form-field">
          ...
          <div class="tabled-checkboxes-rows">
            <div class="d-flex">
              ...
              <div class="tc-row single-field flex-10">
                ...
                <div class="tc-row single-field flex-10">
                    <div class="checkbox-block">
                        <input name="Orders_All_Above"  <?PHP if ($Orders_All_Above==1)  echo "checked"; ?> type="checkbox" value="1" id="Salario">
                    </div>
                </div>
<!--              <div class="tc-row single-field flex-10">-->
<!--                <div class="checkbox-block">-->
...
de Firmus Financial Inc. a su disposicion y solicitud </p>
              ...
              <div class="tc-row single-field flex-10">
                <label for="Si">Si</label>
                <div class="checkbox-block">
                  <input name="Autorise_Firmus" <?PHP if ($Autorise_Firmus==1) echo "checked" ; ?> type="radio" value="1" id="Si">
                </div>
              </div>
              <div class="tc-row single-field flex-10">
                <label for="No">No</label>
                <div class="checkbox-block">
                  <input name="Autorise_Firmus" <?PHP if ($Autorise_Firmus==0) echo "checked" ; ?> type="radio" value="0" id="No">
                </div>
              </div>
            </div>
            <div class="d-flex">
