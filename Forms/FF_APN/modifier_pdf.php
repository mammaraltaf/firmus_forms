...
?>  
  ...
  <body>
<input class="active5" name="btn_pdf" value="Download as PDF File " type="button" onclick="window.location.href='/firmusconnect/Forms/generate_pdf.php?id=<?php echo $id; ?>'">
