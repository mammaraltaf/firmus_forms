    ...
    <section class="wrapper">
      ...
      <div class="fields-block-wrapper">
        ...
        <div class="d-flex mt-16">
          ...
          <div class="single-field flex-5">
            <input name="PEP_Exerc_Aut"  type="radio" <?php if ($PEP_Exerc_Aut==1) echo 'checked'; ?>  id="Títulos2">
          </div>
          <div class="single-field flex-5">
            <input name="PEP_Exerc_Aut"  type="radio"  <?php if ($PEP_Exerc_Aut==0) echo 'checked'; ?> id="Títulos2">
          </div>
        </div>
		<div class="d-flex align-items-center">
          <div class="single-field flex-90">
		...
		<div class="d-flex mt-16">
          ...
          <div class="single-field flex-5">
            <input name="PEP_Manage_PA"  type="radio" <?php if ($PEP_Manage_PA==1) echo 'checked'; ?> id="Títulos2">
          </div>
          <div class="single-field flex-5">
            <input name="PEP_Manage_PA"  type="radio" <?php if ($PEP_Manage_PA==0) echo 'checked'; ?> id="Títulos2">
          </div>
        </div>
		<div class="d-flex align-items-center">
          <div class="single-field flex-90">
