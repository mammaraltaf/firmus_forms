...
$E_ID_Expire_Date=getPostValue('E_ID_Expire_Date');
...
$db->query("update FOR_FF_PNA_ES set
E_Name=$E_Name,
E_surname=$E_surname,
E_Country=$E_Country,
E_ID_type=$E_ID_type,
...
RF_a_FATCA_USA=$RF_a_FATCA_USA,
RF_a_FATCA_NA=$RF_a_FATCA_NA,
RF_a_CRS_Panama=$RF_a_CRS_Panama,
RF_a_CRS_Other=$RF_a_CRS_Other,
RF_b_FATCA_USA=$RF_b_FATCA_USA,
RF_b_FATCA_NA=$RF_b_FATCA_NA,
RF_b_CRS_Panama=$RF_b_CRS_Panama,
RF_b_CRS_Other=$RF_b_CRS_Other,
RF_c_FATCA_USA=$RF_c_FATCA_USA,
RF_c_FATCA_NA=$RF_c_FATCA_NA,
RF_c_CRS_Panama=$RF_c_CRS_Panama,
RF_c_CRS_Other=$RF_c_CRS_Other,
RF_d_FATCA_USA=$RF_d_FATCA_USA,
RF_d_FATCA_NA=$RF_d_FATCA_NA,
RF_d_CRS_Panama=$RF_d_CRS_Panama,
RF_d_CRS_Other=$RF_d_CRS_Other,
RF_e_FATCA_USA=$RF_e_FATCA_USA,
RF_e_FATCA_NA=$RF_e_FATCA_NA,
RF_e_CRS_Panama=$RF_e_CRS_Panama,
RF_e_CRS_Other=$RF_e_CRS_Other,
CRF_Country1=$CRF_Country1,
CRF_City1=$CRF_City1,
CRF_RequireIF1=$CRF_RequireIF1,
CRF_TIN_No1=$CRF_TIN_No1,
CRF_Adress1=$CRF_Adress1,
CRF_Country2=$CRF_Country2,
CRF_City2=$CRF_City2,
CRF_RequireIF2=$CRF_RequireIF2,
CRF_TIN_No2=$CRF_TIN_No2,
CRF_Adress2=$CRF_Adress2,
CRF_Country3=$CRF_Country3,
CRF_City3=$CRF_City3,
CRF_RequireIF3=$CRF_RequireIF3,
CRF_TIN_No3=$CRF_TIN_No3,
CRF_Adress3=$CRF_Adress3,
NOTIN1_A=$NOTIN1_A,
NOTIN1_B=$NOTIN1_B,
NOTIN1_R=$NOTIN1_R,
NOTIN2_A=$NOTIN2_A,
...
NOTIN3_B=$NOTIN3_B,
NOTIN3_R=$NOTIN3_R,
Person_Name_CtrlFE1=$Person_Name_CtrlFE1,
Person_Name_CtrlFE2=$Person_Name_CtrlFE2,
Person_Name_CtrlFE3=$Person_Name_CtrlFE3,
Full_name=$Full_name,
