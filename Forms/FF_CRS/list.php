...
echo "<h3>Autocertificación de Residencia Fiscal Para Entidades (FF-CRS-ES-V.01)</h3>";
...
echo "</table>";
echo "<br>";
echo "+<a class='active5' href=FOR_FF_CRS_ES.html>Add New FORM : FOR_FF_CRS_ES</a>";
