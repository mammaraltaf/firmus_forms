...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3>pertura de Cuenta Persona Natural – Cotitular (FF-PNC-ES-V.01)</h3>
...
$db->query("SELECT id,account_number,E_Name, E_surname,E_Country FROM  FOR_FF_PNC_ES order by id");
...
echo "</tbody>";
echo "</table>";
echo "<a href='FOR_FF_PNC_ES.html' class='btn btn-success mt-3'>Add New FORM: FOR_FF_PNC_ES</a>";
?>
</div>
